...
//gradient bar chart
    ...
    barChart_2gradientStroke.addColorStop(1, "rgba(54, 149, 235, 0.5)");
...
if(jQuery('#barChart_3').length > 0 ){
    ...
    barChart_3gradientStroke.addColorStop(0, "rgba(54, 149, 235, 1)");
    barChart_3gradientStroke.addColorStop(1, "rgba(54, 149, 235, 0.5)");
            ...
            datasets: [
                {
                    ...
                    pointBackgroundColor: 'rgba(54, 149, 235, 1)'
                }
            ]
        },
        options: {
...
if(jQuery('#lineChart_2').length > 0 ){
    ...
    lineChart_2gradientStroke.addColorStop(0, "rgba(54, 149, 235, 1)");
    lineChart_2gradientStroke.addColorStop(1, "rgba(54, 149, 235, 0.5)");
    ...
    Chart.controllers.line = Chart.controllers.line.extend({
        draw: function () {
            ...
            nk.stroke = function () {
                nk.save();
                nk.shadowColor = 'rgba(69, 69, 69, .2)';
                nk.shadowBlur = 10;
                nk.shadowOffsetX = 0;
                nk.shadowOffsetY = 10;
                _stroke.apply(this, arguments)
            ...
            datasets: [
                {
                    ...
                    borderWidth: "2",
                    backgroundColor: 'transparent', 
                    pointBackgroundColor: 'rgba(54, 149, 235, 0.5)'
                }
            ]
        },
        options: {
...
if(jQuery('#lineChart_3').length > 0 ){
    ...
    lineChart_3gradientStroke1.addColorStop(0, "rgba(54, 149, 235, 1)");
    lineChart_3gradientStroke1.addColorStop(1, "rgba(54, 149, 235, 0.5)");
            ...
            datasets: [
                {
                    ...
                    borderWidth: "1",
                    backgroundColor: 'rgba(54, 149, 235, .5)', 
